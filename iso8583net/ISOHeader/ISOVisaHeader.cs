...
{
    public class ISOVisaHeader : ISOHeader
    {
        ...
        public ISOVisaHeader(ILogger logger) : base (logger)
        {
            h01_HeaderLength = "00";
        ...
        public ISOVisaHeader(ILogger logger, ISOHeaderPackager isoHeaderPackager) : base (logger)
        {
            h01_HeaderLength = "00";
            h02_HeaderFlagAndFormat = "00";
            h03_TextFormat = "00";
